...
echo -e "\033[32mIniciando Celery Beat Scheduler...\033[0m"
...
echo -e "\033[33mVerificando migraciones...\033[0m"
python manage.py migrate

# Iniciar Celery Beat
echo -e "\033[32mIniciando Celery Beat con DatabaseScheduler...\033[0m"
