...
class XslxReader:
    ...
    def proccess_file(self, df, nombre_archivo):
        ...
        try:
            with transaction.atomic():
                ...
                self._procesar_caracteristicas_bulk(df, genes_dict, nombre_archivo, resultados)
    ...
    def _procesar_caracteristicas_bulk(self, df, genes_dict, nombre_archivo, resultados):
        ...
        logger.info(f"Encontradas {len(caracteristicas_existentes)} características existentes")
        ...
        if caracteristicas_actualizar:
            logger.info(f"Actualizando {len(caracteristicas_actualizar)} características...")
