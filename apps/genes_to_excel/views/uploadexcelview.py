...
class UploadExcelView(APIView):
    ...
    def post(self, request):
        ...
        nombre_archivo = serializer.validated_data["nombre_archivo"] #serializer.validated_data.get("nombre_archivo", archivo.name)
        print(f"Este es el nombre del archivo: {nombre_archivo}")

        try:
            # Read the Excel file
            excel_file = pd.ExcelFile(archivo) # Revisar si no necesita un codificador específico
