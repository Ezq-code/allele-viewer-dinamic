...
class UploadExcelView(APIView):
    ...
    def _leer_excel_optimizado(self, archivo):
        ...
        try:
            ...
            if all_dfs:
                ...
                logger.info(
                    f"Excel cargado: {total_filas} filas totales en {elapsed_time:.2f} segundos"
                )
                return df
            else:
                return None
    ...
    def post(self, request):
        ...
        try:
            ...
            # Log de resultados
            logger.info(
                f"✅ Procesamiento completado en {resultados['tiempo_procesamiento']:.2f} segundos"
            )
            ...
            if resultados.get("errores") and len(resultados["errores"]) > 0:
                ...
                status_code = (
                    ...
                    if len(resultados["errores"]) < len(df)
