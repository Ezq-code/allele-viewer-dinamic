...
urlpatterns = [
    path('admin/clear-all-data/', admin_views.ClearAppDataView.as_view(), name='clear-all-data'), 
    path('v1/listgenes', genview.GenListView.as_view(), name='list-genes'),
    path('v1/upload_excel', uploadexcelview.UploadExcelView.as_view(), name='upload-excel'),
