...
class CaracteristicaGen(models.Model):
    gen = models.ForeignKey(Gene, on_delete=models.CASCADE, related_name='caracteristicas')
    # Campo para identificar el archivo Excel de origen
    archivo_origen = models.CharField(max_length=255, help_text="Nombre del archivo Excel de origen")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['gen', 'cord'], 
                name='unique_gen_cord_combination'
            )
        ]
        indexes = [
