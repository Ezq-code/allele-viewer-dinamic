...
class Feature(models.Model):
    feature_type = models.CharField(
        max_length=255, verbose_name=_("FeatureType"), default="Feature"
    )
    ...
    place = models.CharField(
        max_length=255, verbose_name=_("Place"), null=True, blank=True
    )
    time = models.IntegerField(verbose_name=_("Time"), null=True, blank=True)
    title = models.CharField(
        max_length=255, verbose_name=_("Title"), null=True, blank=True
    )
    timefinal = models.IntegerField(verbose_name=_("TimeFinal"), null=True, blank=True)
    geometry_type = models.CharField(
        max_length=255, verbose_name=_("GeometryType"), null=True, blank=True
    )
