...
class XslxToPdbByLocationPlusEstStudy(XslxToPdbByProtein):
    def __init__(self, origin_file, global_configuration, uploaded_file_id) -> None:
        self.gen_allele_study_type, _ = StudyType.objects.get_or_create(
            name=StudyType.STUDY_NAME_LOCATION_PLUS_EST,
            defaults={"sheet_name": StudyType.SHEET_NAME_LOCATION_PLUS_EST},
        )
        ...
        try:
            excel_nomenclator = ExcelNomenclatorsByLocationPlusEstStudy(
