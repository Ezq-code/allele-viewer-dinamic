...
const url = '../product-gestion/destination/'
    ...
    $('table')
        ...
        .DataTable({
            ...
            ajax: function (data, callback, settings) {
                ...
                axios.get('../product-gestion/destination/', {
                    params: {
    ...
    if (button.data('type') == "edit") {
        ...
        axios.get(`${url}${selected_id}/`)
            .then(function (response) {
                ...
                form.elements.myenabled.value = elemento.enabled;
                if (elemento.enabled) {
        ...
        modal.find('.modal-title').text('Crear Destino ')
    }
