    ...
    $('table')
        ...
        .DataTable({
            ...
            columns: [
                ...
                { data: "classification_name", "title": "Clasificación" },
    ...
    if (button.data('type') == "edit") {
        ...
        axios.get(`${url}${selected_id}/`)
            .then(function (response) {
                ...
                form.elements.classification.value = elemento.classification;
                form.elements.description.value = elemento.description;
                $('#classification').select2({ dropdownParent: $('#modal-crear-elemento'), theme: 'bootstrap4' });
                $('#individual_packaging').val(elemento.classification).trigger('change.select2');
...
form.addEventListener('submit', function (event) {
    ...
    data.append("classification", document.getElementById("classification").value);
